...
func (s *Float64Seq) getSlice() Float64s {
	if s == nil {
		return nil
	}
	return s.slice
...
func (s *Float64Seq) getTimeIndex() map[timeKey][]int {
	if s == nil {
		return nil
	}
	return s.timeIndex
...
func (s *Float64Seq) getValueIndex() map[float64][]int {
	if s == nil {
		return nil
	}
	return s.valueIndex
...
// Truncate returns a sub *Float64Seq with specified interval
func (s *Float64Seq) Truncate(interval Interval) *Float64Seq {
	sslice := s.getSlice()
	slice := Truncate(sslice, interval).(Float64s)
	return newFloat64Seq(slice)
}
