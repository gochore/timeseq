...
func (s *Uint32Seq) slice() Uint32s {
	if s == nil {
		return nil
	}
	return s.innerSlice
...
func (s *Uint32Seq) buildIndex() {
	...
	s.indexOnce.Do(func() {
		...
		valueIndex := make(map[uint32][]int, len(s.innerSlice))
...
// Range returns a *Uint32Seq without elements which make fn returns true
