...
func TestFloat64Seq_Truncate(t *testing.T) {
	data := RandomFloat64s(100)
	Sort(data)
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			s := NewFloat64Seq(data)
			if got := s.Truncate(tt.args.interval).Float64s(); !reflect.DeepEqual(got, tt.want) {
...
func TestFloat64Seq_Slice(t *testing.T) {
	data := RandomFloat64s(100)
	Sort(data)
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			s := newFloat64Seq(data)
			if got := s.Slice(tt.args.i, tt.args.j).Float64s(); !reflect.DeepEqual(got, tt.want) {
...
func TestFloat64Seq_Trim(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			s := NewFloat64Seq(data)
			if got := s.Trim(tt.args.fn).Float64s(); !reflect.DeepEqual(got, tt.want) {
...
func TestFloat64Seq_Merge(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			s := NewFloat64Seq(tt.data)
			if got := s.Merge(tt.args.fn, WrapFloat64Seq(tt.args.slice)).Float64s(); !reflect.DeepEqual(got, tt.want) {
...
func TestFloat64Seq_Aggregate(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			s := NewFloat64Seq(tt.slice)
			if got := s.Aggregate(tt.args.fn, tt.args.duration, tt.args.interval).Float64s(); !reflect.DeepEqual(got, tt.want) {
