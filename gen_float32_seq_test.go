...
func TestFloat32Seq_Truncate(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			s := NewFloat32Seq(data)
			if got := s.Truncate(tt.args.rg).Float32s(); !reflect.DeepEqual(got, tt.want) {
...
func TestFloat32Seq_Aggregate(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if got := s.Aggregate(tt.args.fn, tt.args.duration, tt.args.rg).Float32s(); !reflect.DeepEqual(got, tt.want) {
