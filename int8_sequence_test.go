...
func TestInt8Sequence_Len(t *testing.T) {
	tests := []struct {
		name string
		s    Int8Sequence
		want int
		...
		{
			s:    RandomInt8Sequence(10),
			want: 10,
		},
		{
			s:    RandomInt8Sequence(0),
			want: 0,
		},
		{
			s:    nil,
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := tt.s.Len(); got != tt.want {
				t.Errorf("Int8Sequence.Len() = %v, want %v", got, tt.want)
			}
		})
	}
}

func TestInt8Sequence_Swap(t *testing.T) {
	type args struct {
		i int
		j int
	}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if ti != tt.s.Time(tt.args.j) || tj != tt.s.Time(tt.args.i) {
				t.Errorf("Int8Sequence.Swap() failed")
			}
		})
	}
}

func TestInt8Sequence_Time(t *testing.T) {
	seq := RandomInt8Sequence(10)
	seq.Sort()
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := tt.s.Time(tt.args.i); !reflect.DeepEqual(got, tt.want) {
				t.Errorf("Int8Sequence.Time() = %v, want %v", got, tt.want)
			}
		})
	}
}

func TestInt8Sequence_Slice(t *testing.T) {
	seq := RandomInt8Sequence(10)
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := tt.s.Slice(tt.args.i, tt.args.j); !reflect.DeepEqual(got, tt.want) {
				t.Errorf("Int8Sequence.Slice() = %v, want %v", got, tt.want)
			}
		})
	}
}

func TestInt8Sequence_Sort(t *testing.T) {
	tests := []struct {
		name string
		s    Int8Sequence
	}{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if !sort.IsSorted(sortableSequence{tt.s}) {
				t.Error("Int8Sequence.Slice() failed")
			}
		})
	}
}

func TestInt8Sequence_Range(t *testing.T) {
	now := time.Now()
	seq := RandomInt8Sequence(10)
	for i := range seq {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := tt.s.Range(tt.args.afterOrEqual, tt.args.beforeOrEqual); !reflect.DeepEqual(got, tt.want) {
				t.Errorf("Int8Sequence.Range() = %v, want %v", got, tt.want)
			}
		})
	}
}

func TestInt8Sequence_First(t *testing.T) {
	now := time.Now()
	seq := RandomInt8Sequence(10)
	for i := range seq {
		seq[i].Time = now.Add(time.Duration(i) * time.Second)
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := tt.s.First(tt.args.afterOrEqual); !reflect.DeepEqual(got, tt.want) {
				t.Errorf("Int8Sequence.First() = %v, want %v", got, tt.want)
			}
		})
	}
}

func TestInt8Sequence_Last(t *testing.T) {
	now := time.Now()
	seq := RandomInt8Sequence(10)
	for i := range seq {
		seq[i].Time = now.Add(time.Duration(i) * time.Second)
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := tt.s.Last(tt.args.beforeOrEqual); !reflect.DeepEqual(got, tt.want) {
				t.Errorf("Int8Sequence.Last() = %v, want %v", got, tt.want)
			}
		})
	}
}

func TestInt8Sequence_Max(t *testing.T) {
	seq1 := RandomInt8Sequence(10)
	seq1.Sort()
	for i := range seq1 {
		if i == 0 {
			seq1[i].Value = 1
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := tt.s.Max(); !reflect.DeepEqual(got, tt.want) {
				t.Errorf("Int8Sequence.Max() = %v, want %v", got, tt.want)
			}
		})
	}
}

func TestInt8Sequence_Min(t *testing.T) {
	seq1 := RandomInt8Sequence(10)
	seq1.Sort()
	for i := range seq1 {
		if i == 0 {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := tt.s.Min(); !reflect.DeepEqual(got, tt.want) {
				t.Errorf("Int8Sequence.Min() = %v, want %v", got, tt.want)
			}
		})
	}
}

func TestInt8Sequence_Sum(t *testing.T) {
	seq := RandomInt8Sequence(10)
	for i := range seq {
		seq[i].Value = int8(i)
	}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := tt.s.Sum(); got != tt.want {
				t.Errorf("Int8Sequence.Sum() = %v, want %v", got, tt.want)
			}
		})
	}
}

func TestInt8Sequence_Average(t *testing.T) {
	seq := RandomInt8Sequence(10)
	for i := range seq {
		seq[i].Value = int8(i) * 2
	}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := tt.s.Average(); got != tt.want {
				t.Errorf("Int8Sequence.Average() = %v, want %v", got, tt.want)
			}
		})
	}
}

func TestInt8Sequence_Percentile(t *testing.T) {
	seq := RandomInt8Sequence(100)
	for i := range seq {
		seq[i].Value = int8(i) + 1
	}
		...
		t.Run(tt.name, func(t *testing.T) {
			defer func() {
				if r := recover(); r != nil {
					...
					t.Errorf("Int8Sequence.Percentile() failed: %v", r)
				}
			}()
			if got := tt.s.Percentile(tt.args.pct); got != tt.want {
				t.Errorf("Int8Sequence.Percentile() = %v, want %v", got, tt.want)
			}
		})
	}
}
...
func TestMergeInt8(t *testing.T) {
	...
	type args struct {
		seq1 Int8Sequence
		seq2 Int8Sequence
		fn   func(item1, item2 *Int8Item) *Int8Item
	}
	tests := []struct {
		name string
		args args
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := MergeInt8(tt.args.seq1, tt.args.seq2, tt.args.fn); !reflect.DeepEqual(got, tt.want) {
...
func RandomInt8Sequence(length int) Int8Sequence {
	now := time.Now()
