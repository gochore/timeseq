...
func TestMergeInt64(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := MergeInt64(tt.args.seq1, tt.args.seq2, tt.args.fn); !reflect.DeepEqual(got, tt.want) {
				t.Errorf("MergeInt64() = %v, want %v", got, tt.want)
			}
		})
	}
}
...
func RandomInt64Sequence(length int) Int64Sequence {
	...
	for i := range ret {
		ret[i] = Int64Item{
			...
			Value: int64(rand.Float64() * float64(math.MaxInt64)),
		}
	}
	return ret
}
