...
func RandomInt32s(length int) Int32s {
	now := time.Now()
	ret := make(Int32s, length)
	for i := range ret {
...
func TestInt32Seq_NilSafe(t *testing.T) {
	var seq *Int32Seq
	seq.Int32s()
	seq.Index(1)
	seq.Time(time.Now())
	...
	seq.Value(1)
	seq.MValue(1)
	seq.Traverse(func(i int, v Int32) (stop bool) {
		return false
	})
	seq.Sum()
	seq.Max()
	...
	seq.Slice(0, 0)
	seq.Trim(func(i int, v Int32) bool {
		return false
	})
	seq.Merge(func(t time.Time, v1, v2 *int32) *int32 {
		return nil
	}, seq)
	seq.Aggregate(func(t time.Time, slice Int32s) *int32 {
		return nil
	}, time.Hour, Interval{})
}
...
func TestInt32Seq_Int32s(t *testing.T) {
	data := RandomInt32s(100)
	Sort(data)
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			s := NewInt32Seq(data)
			if got := s.Int32s(); !reflect.DeepEqual(got, tt.want) {
...
func TestInt32Seq_Index(t *testing.T) {
	data := RandomInt32s(100)
	Sort(data)
...
func TestInt32Seq_Time(t *testing.T) {
	now := time.Now()
...
func TestInt32Seq_MTime(t *testing.T) {
	now := time.Now()
	yesterday := now.AddDate(0, 0, -1)
	lastMonth := now.AddDate(0, -1, 0)
	lastYear := now.AddDate(-1, 0, 0)
...
func TestInt32Seq_Value(t *testing.T) {
	data := RandomInt32s(100)
	Sort(data)
...
func TestInt32Seq_MValue(t *testing.T) {
	data := RandomInt32s(100)
	Sort(data)
...
func TestInt32Seq_Traverse(t *testing.T) {
	data := RandomInt32s(100)

	type args struct {
		fn func(i int, v Int32) (stop bool)
	}
	tests := []struct {
		name string
		args args
...
func TestInt32Seq_Sum(t *testing.T) {
	data := RandomInt32s(100)
	Sort(data)
	var sum int32
	for _, v := range data {
...
func TestInt32Seq_Max(t *testing.T) {
	data := RandomInt32s(100)
	max := data[0]
	for _, v := range data {
...
func TestInt32Seq_Min(t *testing.T) {
	data := RandomInt32s(100)
	min := data[0]
	for _, v := range data {
...
func TestInt32Seq_First(t *testing.T) {
	data := RandomInt32s(100)
	Sort(data)
...
func TestInt32Seq_Last(t *testing.T) {
	data := RandomInt32s(100)
	Sort(data)
	tests := []struct {
		name string
...
func TestInt32Seq_Percentile(t *testing.T) {
	data := RandomInt32s(100)
	Sort(data)
	for i := range data {
		data[i].Value = int32(i)
	}
...
func TestInt32Seq_Truncate(t *testing.T) {
	data := RandomInt32s(100)
	Sort(data)
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			s := NewInt32Seq(data)
			if got := s.Truncate(tt.args.interval).Int32s(); !reflect.DeepEqual(got, tt.want) {
...
func TestInt32Seq_Slice(t *testing.T) {
	data := RandomInt32s(100)
	Sort(data)
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			s := newInt32Seq(data)
			if got := s.Slice(tt.args.i, tt.args.j).Int32s(); !reflect.DeepEqual(got, tt.want) {
...
func TestInt32Seq_Trim(t *testing.T) {
	data := RandomInt32s(10)
	Sort(data)

	type args struct {
		fn func(i int, v Int32) bool
	}
	tests := []struct {
		name string
		args args
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			s := NewInt32Seq(data)
			if got := s.Trim(tt.args.fn).Int32s(); !reflect.DeepEqual(got, tt.want) {
...
func TestInt32Seq_Merge(t *testing.T) {
	data := RandomInt32s(10)
	Sort(data)

	type args struct {
		fn    func(t time.Time, v1, v2 *int32) *int32
		slice Int32s
	}
	tests := []struct {
		name string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			s := NewInt32Seq(tt.data)
			if got := s.Merge(tt.args.fn, WrapInt32Seq(tt.args.slice)).Int32s(); !reflect.DeepEqual(got, tt.want) {
...
func TestInt32Seq_Aggregate(t *testing.T) {
	type args struct {
		fn       func(t time.Time, slice Int32s) *int32
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			s := NewInt32Seq(tt.slice)
			if got := s.Aggregate(tt.args.fn, tt.args.duration, tt.args.interval).Int32s(); !reflect.DeepEqual(got, tt.want) {
