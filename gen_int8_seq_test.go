...
func TestInt8Seq_Truncate(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			s := NewInt8Seq(data)
			if got := s.Truncate(tt.args.rg).Int8s(); !reflect.DeepEqual(got, tt.want) {
...
func TestInt8Seq_Aggregate(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if got := s.Aggregate(tt.args.fn, tt.args.duration, tt.args.rg).Int8s(); !reflect.DeepEqual(got, tt.want) {
