...
func TestInt64Seq_Truncate(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			s := NewInt64Seq(data)
			if got := s.Truncate(tt.args.rg).Int64s(); !reflect.DeepEqual(got, tt.want) {
...
func TestInt64Seq_Slice(t *testing.T) {
	data := RandomInt64s(100)
	Sort(data)
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			s := newInt64Seq(data)
			if got := s.Slice(tt.args.i, tt.args.j).Int64s(); !reflect.DeepEqual(got, tt.want) {
...
func TestInt64Seq_Aggregate(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if got := s.Aggregate(tt.args.fn, tt.args.duration, tt.args.rg).Int64s(); !reflect.DeepEqual(got, tt.want) {
