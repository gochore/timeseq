...
func RandomUint8s(length int) Uint8s {
	now := time.Now()
	ret := make(Uint8s, length)
	for i := range ret {
...
func TestUint8Seq_NilSafe(t *testing.T) {
	var seq *Uint8Seq
	seq.Uint8s()
	seq.Index(1)
	seq.Time(time.Now())
	...
	seq.Value(1)
	seq.MValue(1)
	seq.Traverse(func(i int, v Uint8) (stop bool) {
		return false
	})
	seq.Sum()
	seq.Max()
	...
	seq.Slice(0, 0)
	seq.Trim(func(i int, v Uint8) bool {
		return false
	})
	seq.Merge(func(t time.Time, v1, v2 *uint8) *uint8 {
		return nil
	}, seq)
	seq.Aggregate(func(t time.Time, slice Uint8s) *uint8 {
		return nil
	}, time.Hour, Interval{})
}
...
func TestUint8Seq_Uint8s(t *testing.T) {
	data := RandomUint8s(100)
	Sort(data)
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			s := NewUint8Seq(data)
			if got := s.Uint8s(); !reflect.DeepEqual(got, tt.want) {
...
func TestUint8Seq_Index(t *testing.T) {
	data := RandomUint8s(100)
	Sort(data)
...
func TestUint8Seq_Time(t *testing.T) {
	now := time.Now()
...
func TestUint8Seq_MTime(t *testing.T) {
	now := time.Now()
	yesterday := now.AddDate(0, 0, -1)
	lastMonth := now.AddDate(0, -1, 0)
	lastYear := now.AddDate(-1, 0, 0)
...
func TestUint8Seq_Value(t *testing.T) {
	data := RandomUint8s(100)
	Sort(data)
...
func TestUint8Seq_MValue(t *testing.T) {
	data := RandomUint8s(100)
	Sort(data)
...
func TestUint8Seq_Traverse(t *testing.T) {
	data := RandomUint8s(100)

	type args struct {
		fn func(i int, v Uint8) (stop bool)
	}
	tests := []struct {
		name string
		args args
...
func TestUint8Seq_Sum(t *testing.T) {
	data := RandomUint8s(100)
	Sort(data)
	var sum uint8
	for _, v := range data {
...
func TestUint8Seq_Max(t *testing.T) {
	data := RandomUint8s(100)
	max := data[0]
	for _, v := range data {
...
func TestUint8Seq_Min(t *testing.T) {
	data := RandomUint8s(100)
	min := data[0]
	for _, v := range data {
...
func TestUint8Seq_First(t *testing.T) {
	data := RandomUint8s(100)
	Sort(data)
...
func TestUint8Seq_Last(t *testing.T) {
	data := RandomUint8s(100)
	Sort(data)
	tests := []struct {
		name string
...
func TestUint8Seq_Percentile(t *testing.T) {
	data := RandomUint8s(100)
	Sort(data)
	for i := range data {
		data[i].Value = uint8(i)
	}
...
func TestUint8Seq_Truncate(t *testing.T) {
	data := RandomUint8s(100)
	Sort(data)
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			s := NewUint8Seq(data)
			if got := s.Truncate(tt.args.interval).Uint8s(); !reflect.DeepEqual(got, tt.want) {
...
func TestUint8Seq_Slice(t *testing.T) {
	data := RandomUint8s(100)
	Sort(data)
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			s := newUint8Seq(data)
			if got := s.Slice(tt.args.i, tt.args.j).Uint8s(); !reflect.DeepEqual(got, tt.want) {
...
func TestUint8Seq_Trim(t *testing.T) {
	data := RandomUint8s(10)
	Sort(data)

	type args struct {
		fn func(i int, v Uint8) bool
	}
	tests := []struct {
		name string
		args args
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			s := NewUint8Seq(data)
			if got := s.Trim(tt.args.fn).Uint8s(); !reflect.DeepEqual(got, tt.want) {
...
func TestUint8Seq_Merge(t *testing.T) {
	data := RandomUint8s(10)
	Sort(data)

	type args struct {
		fn    func(t time.Time, v1, v2 *uint8) *uint8
		slice Uint8s
	}
	tests := []struct {
		name string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			s := NewUint8Seq(tt.data)
			if got := s.Merge(tt.args.fn, WrapUint8Seq(tt.args.slice)).Uint8s(); !reflect.DeepEqual(got, tt.want) {
...
func TestUint8Seq_Aggregate(t *testing.T) {
	type args struct {
		fn       func(t time.Time, slice Uint8s) *uint8
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			s := NewUint8Seq(tt.slice)
			if got := s.Aggregate(tt.args.fn, tt.args.duration, tt.args.interval).Uint8s(); !reflect.DeepEqual(got, tt.want) {
