...
func RandomUint32s(length int) Uint32s {
	now := time.Now()
	ret := make(Uint32s, length)
	for i := range ret {
...
func TestUint32Seq_NilSafe(t *testing.T) {
	var seq *Uint32Seq
	seq.Uint32s()
	seq.Index(1)
	seq.Time(time.Now())
	...
	seq.Value(1)
	seq.MValue(1)
	seq.Traverse(func(i int, v Uint32) (stop bool) {
		return false
	})
	seq.Sum()
	seq.Max()
	...
	seq.Truncate(Range{})
	seq.Slice(0, 0)
	seq.Trim(func(i int, v Uint32) bool {
		return false
	})
	seq.Merge(func(t time.Time, v1, v2 *uint32) *uint32 {
		return nil
	}, seq)
	seq.Aggregate(func(t time.Time, slice Uint32s) *uint32 {
		return nil
	}, time.Hour, Range{})
}
...
func TestUint32Seq_Uint32s(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			s := NewUint32Seq(data)
			if got := s.Uint32s(); !reflect.DeepEqual(got, tt.want) {
...
func TestUint32Seq_Index(t *testing.T) {
	data := RandomUint32s(100)
	Sort(data)
...
func TestUint32Seq_Time(t *testing.T) {
	now := time.Now()
...
func TestUint32Seq_MTime(t *testing.T) {
	now := time.Now()
	yesterday := now.AddDate(0, 0, -1)
	lastMonth := now.AddDate(0, -1, 0)
	lastYear := now.AddDate(-1, 0, 0)
...
func TestUint32Seq_Value(t *testing.T) {
	data := RandomUint32s(100)
	Sort(data)
...
func TestUint32Seq_MValue(t *testing.T) {
	data := RandomUint32s(100)
	Sort(data)
...
func TestUint32Seq_Traverse(t *testing.T) {
	data := RandomUint32s(100)

	type args struct {
		fn func(i int, v Uint32) (stop bool)
	}
	tests := []struct {
		name string
		args args
...
func TestUint32Seq_Sum(t *testing.T) {
	data := RandomUint32s(100)
	Sort(data)
	var sum uint32
	for _, v := range data {
...
func TestUint32Seq_Max(t *testing.T) {
	data := RandomUint32s(100)
	max := data[0]
	for _, v := range data {
...
func TestUint32Seq_Min(t *testing.T) {
	data := RandomUint32s(100)
	min := data[0]
	for _, v := range data {
...
func TestUint32Seq_First(t *testing.T) {
	data := RandomUint32s(100)
	Sort(data)
...
func TestUint32Seq_Last(t *testing.T) {
	data := RandomUint32s(100)
	Sort(data)
	tests := []struct {
		name string
...
func TestUint32Seq_Percentile(t *testing.T) {
	data := RandomUint32s(100)
	Sort(data)
	for i := range data {
		data[i].Value = uint32(i)
	}
...
func TestUint32Seq_Truncate(t *testing.T) {
	data := RandomUint32s(100)
	Sort(data)
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			s := NewUint32Seq(data)
			if got := s.Truncate(tt.args.rg).Uint32s(); !reflect.DeepEqual(got, tt.want) {
...
func TestUint32Seq_Slice(t *testing.T) {
	data := RandomUint32s(100)
	Sort(data)
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			s := newUint32Seq(data)
			if got := s.Slice(tt.args.i, tt.args.j).Uint32s(); !reflect.DeepEqual(got, tt.want) {
...
func TestUint32Seq_Trim(t *testing.T) {
...
func TestUint32Seq_Aggregate(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if got := s.Aggregate(tt.args.fn, tt.args.duration, tt.args.rg).Uint32s(); !reflect.DeepEqual(got, tt.want) {
