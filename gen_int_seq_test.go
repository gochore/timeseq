...
func TestIntSeq_NilSafe(t *testing.T) {
	var seq *IntSeq
	seq.Ints()
	seq.Index(1)
	seq.Time(time.Now())
	...
	seq.Value(1)
	seq.MValue(1)
	seq.Traverse(func(i int, v Int) (stop bool) {
		return false
	})
	seq.Sum()
	seq.Max()
	...
	seq.Merge(func(t time.Time, v1, v2 *int) *int {
		return nil
	}, seq)
	seq.Aggregate(func(t time.Time, slice Ints) *int {
		return nil
	}, time.Hour, Range{})
}
...
func TestIntSeq_Truncate(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			s := NewIntSeq(data)
			if got := s.Truncate(tt.args.rg).Ints(); !reflect.DeepEqual(got, tt.want) {
...
func TestIntSeq_Slice(t *testing.T) {
	data := RandomInts(100)
	Sort(data)
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			s := newIntSeq(data)
			if got := s.Slice(tt.args.i, tt.args.j).Ints(); !reflect.DeepEqual(got, tt.want) {
...
func TestIntSeq_Trim(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			s := NewIntSeq(data)
			if got := s.Trim(tt.args.fn).Ints(); !reflect.DeepEqual(got, tt.want) {
...
func TestIntSeq_Merge(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			s := NewIntSeq(tt.data)
			if got := s.Merge(tt.args.fn, WrapIntSeq(tt.args.slice)).Ints(); !reflect.DeepEqual(got, tt.want) {
...
func TestIntSeq_Aggregate(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			s := NewIntSeq(tt.slice)
			if got := s.Aggregate(tt.args.fn, tt.args.duration, tt.args.rg).Ints(); !reflect.DeepEqual(got, tt.want) {
