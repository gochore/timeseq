...
func TestUint64Seq_Count(t *testing.T) {
	data := RandomUint64s(100)
	...
	tests := []struct {
		...
		},
		{
			...
			args: args{
				...
				slices: []Uint64s{
					append(Uint64s{data[9]}, data[3:9]...),
				},
			},
			want: data,
		},
...
func TestUint64Seq_Clone(t *testing.T) {
	data := RandomUint64s(10)
	Sort(data)
	tests := []struct {
		name string
