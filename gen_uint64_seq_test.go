...
func RandomUint64s(length int) Uint64s {
	now := time.Now()
	ret := make(Uint64s, length)
	for i := range ret {
...
func TestUint64Seq_NilSafe(t *testing.T) {
	var seq *Uint64Seq
	seq.Uint64s()
	seq.Index(1)
	seq.Time(time.Now())
	...
	seq.Value(1)
	seq.MValue(1)
	seq.Traverse(func(i int, v Uint64) (stop bool) {
		return false
	})
	seq.Sum()
	seq.Max()
	...
	seq.Slice(0, 0)
	seq.Trim(func(i int, v Uint64) bool {
		return false
	})
	seq.Merge(func(t time.Time, v1, v2 *uint64) *uint64 {
		return nil
	}, seq)
	seq.Aggregate(func(t time.Time, slice Uint64s) *uint64 {
		return nil
	}, time.Hour, Interval{})
}
...
func TestUint64Seq_Uint64s(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			s := NewUint64Seq(data)
			if got := s.Uint64s(); !reflect.DeepEqual(got, tt.want) {
...
func TestUint64Seq_Index(t *testing.T) {
	data := RandomUint64s(100)
	Sort(data)
...
func TestUint64Seq_MValue(t *testing.T) {
	data := RandomUint64s(100)
	Sort(data)
...
func TestUint64Seq_Traverse(t *testing.T) {
	...
	type args struct {
		fn func(i int, v Uint64) (stop bool)
	}
	tests := []struct {
		name string
		args args
...
func TestUint64Seq_Sum(t *testing.T) {
	data := RandomUint64s(100)
	Sort(data)
	var sum uint64
	for _, v := range data {
...
func TestUint64Seq_Max(t *testing.T) {
	data := RandomUint64s(100)
	max := data[0]
	for _, v := range data {
...
func TestUint64Seq_Min(t *testing.T) {
	data := RandomUint64s(100)
	min := data[0]
	for _, v := range data {
...
func TestUint64Seq_First(t *testing.T) {
	data := RandomUint64s(100)
	Sort(data)
...
func TestUint64Seq_Last(t *testing.T) {
	data := RandomUint64s(100)
	Sort(data)
	tests := []struct {
		name string
...
func TestUint64Seq_Percentile(t *testing.T) {
	data := RandomUint64s(100)
	Sort(data)
	for i := range data {
		data[i].Value = uint64(i)
	}
...
func TestUint64Seq_Truncate(t *testing.T) {
	data := RandomUint64s(100)
	Sort(data)
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			s := NewUint64Seq(data)
			if got := s.Truncate(tt.args.interval).Uint64s(); !reflect.DeepEqual(got, tt.want) {
...
func TestUint64Seq_Slice(t *testing.T) {
	data := RandomUint64s(100)
	Sort(data)
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			s := newUint64Seq(data)
			if got := s.Slice(tt.args.i, tt.args.j).Uint64s(); !reflect.DeepEqual(got, tt.want) {
...
func TestUint64Seq_Trim(t *testing.T) {
	data := RandomUint64s(10)
	Sort(data)

	type args struct {
		fn func(i int, v Uint64) bool
	}
	tests := []struct {
		name string
		args args
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			s := NewUint64Seq(data)
			if got := s.Trim(tt.args.fn).Uint64s(); !reflect.DeepEqual(got, tt.want) {
...
func TestUint64Seq_Merge(t *testing.T) {
	data := RandomUint64s(10)
	Sort(data)

	type args struct {
		fn    func(t time.Time, v1, v2 *uint64) *uint64
		slice Uint64s
	}
	tests := []struct {
		name string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			s := NewUint64Seq(tt.data)
			if got := s.Merge(tt.args.fn, WrapUint64Seq(tt.args.slice)).Uint64s(); !reflect.DeepEqual(got, tt.want) {
...
func TestUint64Seq_Aggregate(t *testing.T) {
	type args struct {
		fn       func(t time.Time, slice Uint64s) *uint64
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			s := NewUint64Seq(tt.slice)
			if got := s.Aggregate(tt.args.fn, tt.args.duration, tt.args.interval).Uint64s(); !reflect.DeepEqual(got, tt.want) {
