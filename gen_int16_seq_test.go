...
func TestInt16Seq_NilSafe(t *testing.T) {
	var seq *Int16Seq
	seq.Int16s()
	seq.Index(1)
	seq.Time(time.Now())
	...
	seq.Value(1)
	seq.MValue(1)
	seq.Traverse(func(i int, v Int16) (stop bool) {
		return false
	})
	seq.Sum()
	seq.Max()
	...
	seq.Slice(0, 0)
	seq.Trim(func(i int, v Int16) bool {
		return false
	})
	seq.Merge(func(t time.Time, v1, v2 *int16) *int16 {
		return nil
	}, seq)
	seq.Aggregate(func(t time.Time, slice Int16s) *int16 {
		return nil
	}, time.Hour, Interval{})
}
...
func TestInt16Seq_Truncate(t *testing.T) {
	data := RandomInt16s(100)
	Sort(data)
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			s := NewInt16Seq(data)
			if got := s.Truncate(tt.args.interval).Int16s(); !reflect.DeepEqual(got, tt.want) {
...
func TestInt16Seq_Slice(t *testing.T) {
	data := RandomInt16s(100)
	Sort(data)
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			s := newInt16Seq(data)
			if got := s.Slice(tt.args.i, tt.args.j).Int16s(); !reflect.DeepEqual(got, tt.want) {
...
func TestInt16Seq_Trim(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			s := NewInt16Seq(data)
			if got := s.Trim(tt.args.fn).Int16s(); !reflect.DeepEqual(got, tt.want) {
...
func TestInt16Seq_Merge(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			s := NewInt16Seq(tt.data)
			if got := s.Merge(tt.args.fn, WrapInt16Seq(tt.args.slice)).Int16s(); !reflect.DeepEqual(got, tt.want) {
...
func TestInt16Seq_Aggregate(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			s := NewInt16Seq(tt.slice)
			if got := s.Aggregate(tt.args.fn, tt.args.duration, tt.args.interval).Int16s(); !reflect.DeepEqual(got, tt.want) {
